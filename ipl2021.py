...
points_table_data_url = 'https://www.iplt20.com/points-table/men/2021'
...
# st.header("Points Table of IPL 2021")
st.markdown("<h2 style='text-align: center; color: blue;'><strong><u> Points Table of IPL 2021 </u></strong></h2>", unsafe_allow_html=True)
...
batting_stats_data_url = 'https://www.iplt20.com/stats/2021/most-runs'
...
if select_bat_bowl == 'Batting stats':
    ...
    if select_category == 'Top Run Scorer':
        ...
        best_avg_data_url = 'https://www.iplt20.com/stats/2021/best-batting-average'
        # most_run_data_url = 'https://www.iplt20.com/stats/2020/most-runs'
...
bowling_stats_data_url = 'https://www.iplt20.com/stats/2021/most-wickets'
# most_run_data_url = 'https://www.iplt20.com/stats/2020/most-runs'
...
######################################### !st category
    if select_category == 'Top Wicket Taker':
        ...
        st.markdown("_________________________________________________________________________________")
            ...
            df_bowl_best_avg = data_bowling_stats.sort_values(by=['Average']).head(3)
            x = np.arange(1, 4)
...
st.sidebar.markdown("<h1 style='text-align: center; color: #F34600;'><u><strong>Schedule of IPL 2021</strong></u></h1>", unsafe_allow_html=True)
...
st.sidebar.markdown("<h4 style='text-align: center; '>You can check all the scheduled matches of IPL 2021, along with various other details like timing, Venue etc.</h4>", unsafe_allow_html=True)
...
if st.sidebar.checkbox("Show IPL 2021 scheduled matches", False):
    st.markdown("&nbsp")
    # st.markdown("&nbsp")
    # st.header("IPL 2020 Scheduled Matches")
    st.markdown("<h2 style='text-align: center; color: #BD08D3;'><strong><u>All Scheduled matches of IPL 2021</u></strong></h2>", unsafe_allow_html=True)
    ...
    image = pd.read_csv(r"C:\Users\dhchaudhary\Desktop\IPL-2021-Dashboard\schedule\ipl_schedule.csv")
...
if favourite_team == 'Chennai Super Kings (CSK)':
    # @st.cache(persist=True)
    csk = pd.read_csv(r"C:\Users\dhchaudhary\Desktop\IPL-2021-Dashboard\schedule\csk_schedule.csv")
    # st.image(image, use_column_width=True)
...
#
    ...
    mi = pd.read_csv(r"C:\Users\dhchaudhary\Desktop\IPL-2021-Dashboard\schedule\mi_schedule.csv")
    ...
    rcb = pd.read_csv(r"C:\Users\dhchaudhary\Desktop\IPL-2021-Dashboard\schedule\rcb_schedule.csv")
    ...
    srh = pd.read_csv(r"C:\Users\dhchaudhary\Desktop\IPL-2021-Dashboard\schedule\srh_schedule.csv")
    ...
    dc = pd.read_csv(r"C:\Users\dhchaudhary\Desktop\IPL-2021-Dashboard\schedule\dc_schedule.csv")
    ...
    punjab = pd.read_csv(r"C:\Users\dhchaudhary\Desktop\IPL-2021-Dashboard\schedule\punjab_schedule.csv")
    punjab= punjab[['Match No', 'Match Center','Date','Day',  'Time (IST)', 'Stadium', 'City']]
    st.markdown("&nbsp")
    # st.markdown("&nbsp")
    ...
    rr = pd.read_csv(r"C:\Users\dhchaudhary\Desktop\IPL-2021-Dashboard\schedule\rajasthan_schedule.csv")
    ...
    kkr = pd.read_csv(r"C:\Users\dhchaudhary\Desktop\IPL-2021-Dashboard\schedule\kkr_schedule.csv")
